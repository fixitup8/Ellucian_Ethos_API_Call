# Postman collection: Ethos Integration Examples > Next Steps > Read all persons paging 3
#
...
result = ethos_client.sendGetRequest(
    url="/api/persons",
    params={"offset": "200", "limit": "100"},
    loginSession=login_session,
    injectHeadersFn=None
)

persons = json.loads(result.content)
print("Page 3 - persons returned:", len(persons))
