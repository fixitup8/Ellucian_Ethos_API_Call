# Postman collection: Ethos Integration Examples > Some Basics > Publish single change-notification
#
...
change_notification_to_publish = {
    "resource": {
        "name": "buildings",
...
result = ethos_client.sendPostRequest(
    ...
    data=json.dumps(change_notification_to_publish)
)
